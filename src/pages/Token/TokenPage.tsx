          ...
          !tokenData.exists ? (
            <LightGreyCard style={{ textAlign: 'center' }}>
              ...
              <StyledExternalLink
                ...
                href={`https://swap.xsidra.com/?token0=${formattedAddress}`}
              >
                here.
              </StyledExternalLink>
            </LightGreyCard>
            ...
            <AutoColumn $gap="32px">
              <AutoColumn $gap="32px">
                ...
                <ResponsiveRow align="flex-end">
                  ...
                  {activeNetwork !== SidrachianNetworkInfo ? null : (
                    <RowFixed>
                      <StyledExternalLink href={`https://swap.xsidra.com/add/?token0=${formattedAddress}`}>
                      ...
                      <StyledExternalLink href={`https://swap.xsidra.com/?token0=${formattedAddress}`}>
